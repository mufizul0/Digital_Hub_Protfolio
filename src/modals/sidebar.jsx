                ...
                <div className="offcanvas__content">
                    ...
                    <div className="offcanvas__contact">
                        ...
                        <div className="offcanvas__contact-content d-flex">
                            ...
                            <a href="https://www.google.com/maps/place/Digital+Hub+Bangladesh+Ltd/@23.7435577,90.3690644,17z/data=!3m1!4b1!4m6!3m5!1s0x3755bf4b960369c5:0x222c3f3f9659150c!8m2!3d23.7435577!4d90.3716393!16s%2Fg%2F1ptxg88m0?entry=ttu">89/A, Road 8A, Dhanmondi, Dhaka 1209 </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="info@digitalhubbd.com">info@digitalhubbd.com  </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="tel:01310-069824"> +880 01309-514133</a>
                            </div>
                        </div>
                    </div>
